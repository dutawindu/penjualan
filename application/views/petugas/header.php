    ...
    <nav class="blue">
        <div class="nav-wrapper container">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <!-- Dropdown-->
                <li><a class="dropdown-button" href="#!" dataactivates="dropdown1"><i class="mdi-editor-format-list-bulleted" style='font-size: 40px'></i></a></li>
                <li><a class="dropdown-button" href="#!" dataactivates="dropdown2"><i class="mdi-action-settings" style='font-size:40px'></i></a></li>
            </ul>
